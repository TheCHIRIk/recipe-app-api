...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test uploadign an image to reicpe"""
    ...
    def test_filter_recipes_by_tags(self):
        """Test returnining recipes with specific tags"""
        recipe1 = sample_recipe(user=self.user, title='Thai veggie curry')
        recipe2 = sample_recipe(user=self.user, title='Aubergie with tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient3 = sample_ingredient(user=self.user, name='Steak')
